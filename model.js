        ...
        pages.push(
            {
                ...
                paragraphs: [
                    ...
                    '<h3>Autism</h3> This is the OG claim. In 1997 a doctor named Andrew Wakefield published a paper in a medical journal stating that the MMR vaccine caused autism in children. However, the paper has been discredited because of major flaws in the study, manipulation of data and financial conflicts of interest. Wakefield lost his medical license and the journal retracted the paper. Furthermore, there have been numerous studies since looking for a link between the vaccine and autism and there just isn\'t one. Autism is still a bit of a mystery but there is evidence that it starts in utero which, of course, is before infants receive any vaccines.',
                    '<h3>The medical establishment hides the risks so they can get rich</h3> This is fairly easy to debunk after you break down how the medical industry works in the US. I\'ll break it down into the 3 main parts of the industry.',
                    '<h4>Doctors and hospitals</h4> Doctors and hospitals administer the vaccines but they don\'t get to charge hardly anything for them. Insurance companies will limit the amount of money paid for the vaccines (or any services) to roughly what it actually costs the hospital. In many cases, doctors and hospitals actually lose money by providing services in this way where the one size fits all pricing paid for by the insurance company do not actually cover the costs incurred by hospitals because of their specific situations. If a vaccine wasn\'t safe, doctors would call it out, because their patients are being harmed and they aren\'t getting rich off vaccines.',
                    '<h4>Health Insurance</h4> Insurance companies will benefit from you being vaccinated because you won\'t get that particular disease so they won\'t have to pay for its treatment, but if people didn\'t get vaccinated, they would just charge higher premiums to offset that cost so it is kind of a wash at the end of the day. Government-run payer models (Medicare, Medicaid) solve some of this by not being able to raise premiums and deductibles as that is controlled by Congress so that better incentivizes preventative healthcare like vaccines. But, if there was fraud in terms of safety, insurers would call it out because they would be forced into paying for the conditions caused by the vaccine. There could, hypothetically, be a balance here though. If the average COVID diagnosis costs them $5,000 and, hypothetically, the vaccine were to cause a lesser condition, the insurance company would save money by not blowing a whistle. But in this scenario, that lesser condition is just that, a lesser condition, and it would be shown up front as a side effect, and we would still be telling you to get the vaccine.',
